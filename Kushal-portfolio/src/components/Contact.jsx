        ...
        <form ref={form} onSubmit={sendEmail} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col">
            ...
            <textarea
              ...
              rows="5"
              required
              className="px-4 py-2 rounded  bg-opacity-10 border border-white border-opacity-10 focus:outline-none focus:ring-2 focus:ring-cyan-400 text-white placeholder:text-white placeholder-opacity-70 resize-none"
