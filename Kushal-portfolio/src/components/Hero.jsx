...
function Hero() {
  return (
    ...
    >
      ...
      >
        <h1 className="text-4xl md:text-6xl font-bold text-cyan-400">Hi, I'm Kushal Pandey</h1>
        ...
        <p className="mt-6 text-gray-300 text-lg">
         💡 Turning Ideas into Intelligent Web Solutions — Full-Stack MERN Developer with a Passion for Scalable, AI-Powered Products
        </p>

        {/* Buttons */}
        <div className="flex gap-4 mt-6 flex-wrap justify-center md:justify-start">
          <a
            href="/Kushal_Pandey_Resume.pdf"
            download
      ...
      <motion.div
        className="relative w-52 h-52 md:w-100 md:h-100 group"
